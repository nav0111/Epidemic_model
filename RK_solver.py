...
def run_seihrd_model(): 
    ...
    plt.plot(simulationTime, solutionState[:,2], label='I_u', color = 'green')
    plt.plot(simulationTime, solutionState[:,3], label ='I_r', color = 'orange')
    plt.plot(simulationTime, solutionState[:,4], label='H', color = 'purple')
    plt.plot(simulationTime, solutionState[:,5], label= 'R', color = 'brown')
    plt.plot(simulationTime, solutionState[:,6], label= 'D', color = 'black')
    plt.xlabel("time")
